...
import { ICustomer, IEthanol, defaultCustomer, defaultEthanol } from '@/types/customer';
...
<Column body={action_display} header="เลือก" style={{ minWidth: '100px' }} />
  <Column field='type' header="ประเภท" style={{ minWidth: '200px' }} />
<Column field='ingredient' header="ส่วนผสม" style={{ minWidth: '200px' }} />
<Column field='use' header="การใช้งาน" style={{ minWidth: '200px' }} />
