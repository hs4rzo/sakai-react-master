...
import { IBrand, defaultBrand } from '@/types/brand';
...
const items: MenuItem[] = [{ label: 'Database' }, { label: 'รายชื่อยี่ห้อ' }];
...
function LabsPage() {
  ...
  const [labs, setLabs] = useState<IBrand>(defaultBrand);
  ...
  const action_display = (item: IBrand) => {
    return (
        ...
        <div className='col-12 md:col-12 mt-2'>
          <div className="card ">
            ...
            <DataTable
              ...
              value={data}
              filters={filters}
              globalFilterFields={['brand_id', 'brand']}
              stripedRows
              header={header_display}
              paginator rows={15}
              tableStyle={{ width: '100%' }}>
              <Column field='brand_id' header="Id"></Column>
              <Column field='brand' header="Lab Name" style={{ width: '82%' }} ></Column>
